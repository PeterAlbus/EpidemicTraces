...
<div class="d-flex container-fluid toggled" id="wrapper">
    <div class="bg-light border-right" id="sidebar-wrapper">
        ...
        <div class="list-group list-group-flush">
            ...
            <a href="#daily" class="list-group-item list-group-item-action bg-light">中国-饼图</a>
...
<script>
    ...
    <c:forEach items="${chinaProvinceList}" var="chinaProvince">
        data.push({value: ${chinaProvince.value}, name: '${chinaProvince.name}'});
        legend.push('${chinaProvince.name}');
    </c:forEach>
    var myChart=echarts.init(document.querySelector(".box_map"));
    var myChart1=echarts.init(document.querySelector(".box_large"));
    var option;
    option = {
        title: {
            text: '中国各省疫情数据',
