...
<div class="d-flex container-fluid toggled" id="wrapper">
    <div class="bg-light border-right" id="sidebar-wrapper">
        ...
        <div class="list-group list-group-flush">
            ...
            <a href="#predict" class="list-group-item list-group-item-action bg-light">美国确诊人数预测</a>
    ...
    <div id="page-content-wrapper">
        ...
        <section class="page-section" id="predict">
            <div class="container" style="text-align: center">
                <h2 class="text-center mt-0">美国确诊人数预测</h2>
...
<script>
    ...
    <c:choose>
    <c:when test="${predict.getUsa_confirm()==0}">
    a.push('');
    </c:when>
    <c:otherwise>
    a.push(${predict.getUsa_confirm()});
    </c:otherwise>
    </c:choose>
    <c:choose>
    <c:when test="${predict.getUsa_confirm_predict()==0}">
    predict.push('');
    </c:when>
    <c:otherwise>
    predict.push(${predict.getUsa_confirm_predict()});
    </c:otherwise>
    </c:choose>
    <c:choose>
    <c:when test="${predict.getUsa_confirm_adjust()==0}">
    adjust.push('');
    </c:when>
    <c:otherwise>
    adjust.push(${predict.getUsa_confirm_adjust()});
    </c:otherwise>
    </c:choose>
    </c:forEach>
    option = {
